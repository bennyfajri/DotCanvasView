object Versions {
    ...
    const val hilt = "2.44"
    const val hiltAndroidXCompiler = "1.1.0"
    ...
    const val bluetoothPrint = "3.2.0"
    const val window = "1.2.0-alpha03"

    const val valkriaineBouncy = "2.3"
